...
speak("Welcome to the Digital Weather Application. Created By CodeWithSalty on instagram also known as Salmaan"
...
while True:
    ...
    if city == " ":
        ...
        speak("Please Enter a Proper Name of the City Sir")

    if city.lower() == 'q':
        speak("Goodbye! Stay safe and have a nice day my friend !")
        break
...
"""
    try:
        api_key = "ENTER YOUR API KEY HERE OR GET YOURS FROM WEATHERAPI.COM "
        ...
        speak("There was an error retrieving the weather data. Please try again.")
